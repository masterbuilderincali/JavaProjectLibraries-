package com.shao.locationservicetest;
...
public class MainActivity extends Activity {
	  ...
	  private MyLocationListener mylistener; // Used for receiving notifications from the LocationManager when the location has changed
	...
	/** Called when the activity is first created. */
	  ...
	  public void onCreate(Bundle savedInstanceState) {
		  ...
		  // the provider is not allowed to incur monetary cost when it's set false
